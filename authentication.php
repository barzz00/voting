    ...
    " role="navigation">
            <div class="container">
                ...
                <div class="navbar-header">
                    <a href="index.html" class="navbar-brand headerFont text-lg">SIS Voting System In College Department</a>
                </div>
...
if(empty($_POST['adminUserName']) || empty($_POST['adminPassword'])) {
    ...
    if(mysqli_num_rows($query) == 1) {
        ...
        echo "<p class='normalFont text-primary'><strong>Your Combination of UserName and Password is Incorrect. Contact the system developer.</strong></p>";
